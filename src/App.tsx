      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="flex justify-center md:justify-start order-1 md:order-1">
            {!logoError ? (
              <div className="w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 flex items-center justify-center bg-gradient-to-br from-blue-400 to-purple-500 rounded-full shadow-lg">
                <img 
                  src={logoUrl} 
                  alt="Logo" 
          ...
          <div className="text-center md:text-left order-2 md:order-2">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent leading-tight px-2">
              Hello, There!<br />
              Welcome to My World!
            </h1>
            <div className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-6 md:mb-8 h-12 sm:h-14 md:h-16 flex items-center justify-center md:justify-start px-2">
              <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent font-semibold text-center md:text-left">
                {displayedText}
                <span className={`inline-block w-0.5 h-6 bg-blue-400 ml-1 ${showCursor ? 'opacity-100' : 'opacity-0'} transition-opacity duration-100`}>
                  |
                </span>
              </span>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center md:justify-start px-2">
              ...
              <button className="px-6 sm:px-8 py-3 border border-gray-600 hover:border-gray-400 text-gray-300 hover:text-white rounded-lg transition-colors text-sm sm:text-base">
                Get In Touch
              </button>
            </div>
          </div>
  ...
  return (
    <section id="projects" className="py-16 sm:py-20 px-4 bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={projectsRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
          {projects.map((project, index) => (
            ...
            >
              <div className="p-4 sm:p-6 text-center">
                <div className="mb-4 sm:mb-6 h-32 sm:h-36 flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl border border-gray-600 hover:border-blue-400 transition-colors duration-300">
                ...
                <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-white">{project.title}</h3>
                <p className="text-sm sm:text-base text-gray-300 mb-4 sm:mb-6 leading-relaxed min-h-[4rem] sm:min-h-[5rem]">{project.description}</p>
                <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 sm:mb-6 justify-center">
                  {project.tech.map((tech) => (
                    <span key={tech} className="px-3 py-1.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-xs sm:text-sm rounded-full font-medium shadow-md hover:shadow-lg transition-shadow">
                      {tech}
                    </span>
                  ))}
                </div>
                <div className="flex gap-4 sm:gap-6 justify-center text-sm sm:text-base">
                  <a 
                    href={project.demo} 
...
const Skills = () => {
  ...
  const TechLogo = ({ name, children }: { name: string; children: React.ReactNode }) => (
    <div className="group relative">
      <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 flex items-center justify-center bg-gray-800 rounded-xl border border-gray-700 hover:border-blue-400 transition-all duration-300 hover:scale-110 hover:bg-gray-700">
        {children}
      </div>
      <span className="absolute -bottom-6 sm:-bottom-8 left-1/2 transform -translate-x-1/2 text-xs text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
        {name}
      </span>
    </div>
  );
  ...
  return (
    <section id="skills" className="py-16 sm:py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={skillsRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
          {skillCategories.map((category, categoryIndex) => (
            <div key={categoryIndex} className="text-center">
              <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 lg:mb-8 text-blue-400">{category.title}</h3>
